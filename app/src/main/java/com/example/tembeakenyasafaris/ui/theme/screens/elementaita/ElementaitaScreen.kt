package com.example.tembeakenyasafaris.ui.theme.screens.elementaita
...
@Composable
fun ElementaitaScreen(navController: NavController){
...
fun ElementaitaScreenPreview(){
    ElementaitaScreen(rememberNavController())
}
