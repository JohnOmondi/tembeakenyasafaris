package com.example.tembeakenyasafaris.ui.theme.screens.amboseli
...
@Composable
fun AmboseliScreen(navController: NavController){
                ...
                Column(
                    ...
                    Column(
                        ...
                        Card(
                            ...
                            Text(
                                text ="Tour;Home of the African Elephant ",
                                fontSize = 25.sp,
                                color = Color.Black
                            ...
                            Text(
                                text = "Crowned by Mount Kilimanjaro, Africa's highest peak, the Amboseli National Parks is one of Kenya's most popular parks. The name \"Amboseli\" comes from a Maasai word meaning \"salty dust\", and it is one of the best places in Africa to view large herds of elephants up close. Nature lovers can explore five different habitats here ranging from the dried-up bed of Lake Amboseli, wetlands with sulphur springs, the savannah and woodlands.  They can also visit the local Maasai community who live around the park and experience their authentic culture.\n" +
                                        "\n" +
                                        " ",
...
fun AmboseliScreenPreview() {
    AmboseliScreen(rememberNavController())}
