package com.example.tembeakenyasafaris.ui.theme.screens.lakenaivasha
...
@Composable
fun LakenaivashaScreen(navController: NavController){
                ...
                Column(
                    ...
                    Column(
                        ...
                        Card(
                            ...
                            Text(
                                text = "Rising from the floor of the Great Rift Valley like a monolith is the extinct volcano of Mount Longonot. A unique feature is the thick forest that lies within the crater of the mountain. The crater rim also provides great scenic views across the beautiful Rift Valley all the way to Lake Naivasha. Major wildlife attractions at Mount Longonot include buffaloes, elands, lion, leopard, bushbucks, common zebra, giraffe and Grant’s gazelles" +
                                        "\n" +
                                        " ",
...
fun LakenaivashaScreenPreview(){
    LakenaivashaScreen(rememberNavController())
}