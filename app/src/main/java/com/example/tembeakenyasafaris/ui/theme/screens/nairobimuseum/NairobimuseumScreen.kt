package com.example.tembeakenyasafaris.ui.theme.screens.nairobimuseum
...
@Composable
fun NairobimuseumScreen(navController: NavController){
...
fun NairobimuseumScreenPreview(){
    NairobimuseumScreen(rememberNavController())
}